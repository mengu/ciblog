...
class Archives extends Controller
{
    function Archives()
    {
        ...
        $this->header = $this->load->view('header', array('postCount' => $this->postCount, 'perPage' => 5, 'current' => "", 'title' => "Mengu.net - Archives", 'keywords' => Post::getAllTags(true), 'description' => Post::getAllTags(true)), true);
